      ...
      <div className="container text-center">
        <div className="row align-items-center">
          ...
          <div className="col-lg-8 text-start">
            ...
            <p className="lead">
              Hello! I'm <strong>Denis Murangiri</strong>, a passionate Full-Stack Developer specializing in the 
              **MERN Stack (MongoDB, Express.js, React, Node.js,Python, Django, RestAPIs,Git)**. I build scalable, user-friendly web applications.
            </p>
            <p>
            ...
            <div className="d-flex flex-wrap">
              ...
              <span className="badge bg-danger me-2 mb-2">Python Django</span>
              <span className="badge bg-success me-2 mb-2">RestAPI</span>
            </div>
